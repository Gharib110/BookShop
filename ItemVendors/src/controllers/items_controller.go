...
import (
	"encoding/json"
	"fmt"
	"github.com/Gharib110/BookShop/Auth/oauth"
	"github.com/Gharib110/BookShop/BookShop/utils/errors"
	"github.com/Gharib110/BookShop/ItemVendors/src/domain/items"
	"github.com/Gharib110/BookShop/ItemVendors/src/domain/queries"
	"github.com/Gharib110/BookShop/ItemVendors/src/services"
	"github.com/Gharib110/BookShop/ItemVendors/src/utils/http_utils"
...
func (cont *itemsController) Create(w http.ResponseWriter, r *http.Request) {
	...
	if sellerId == 0 {
		respErr := errors.NewUnauthorizedError("invalid access token")
